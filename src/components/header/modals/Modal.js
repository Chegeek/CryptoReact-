                        ...
                        <section className="modal-card-body has-text-centered">
                            ...
                            <p className="has-text-grey-darker">
                                ...
                                <a className="has-text-primary" target="_blank" rel="noopener noreferrer"
                                   href="https://bitcoin.org/en/"> Bitcoin</a>.
                            ...
                            <p className="has-text-grey-darker">
                                ...
                                This project has been inspired by <a className="has-text-primary" target="_blank"
                                                                     rel="noopener noreferrer"
                                                                     href="https://www.cryptovue.com"> CryptoVue</a>
                                , basically the same project, but made in
                                Vue.JS.
                                You can reach me on github or reach the creator of CryptoVue on this <a
                                className="has-text-primary" target="_blank"
                                rel="noopener noreferrer"
                                href="https://github.com/djirdehh/crypto_vue"> github repo</a>.
                            </p>
                        </section>
