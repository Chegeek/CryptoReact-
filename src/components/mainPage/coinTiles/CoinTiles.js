    ...
    render(router) {
        ...
        return(
            <div className="column is-one-quarter has-text-centered notification is-dark background-color-initial">
                <div className="card background-color-initial" onClick={this.handleClick}>
                    ...
                    <div className="columns">
                        <div className="column">
                            <h1 className="title is-5">{coin.name || 'Coin Name'}</h1>
                            <h2 className="subtitle is-4">${coin.price_usd || '$noData'} <span className={upOrDown}> ({coin.percent_change_1h || '2' } %)</span></h2>
                        </div>
                    </div>
                </div>
            </div>
